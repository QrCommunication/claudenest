...
class ClaudeCredential extends Model
{
    ...
    /**
     * Auto-refresh OAuth token if expired and refresh token is available.
     * Returns true if a refresh was performed, false if not needed.
    ...
    public function ensureFresh(): bool
    {
        ...
        $service = app(\App\Services\CredentialService::class);
        $service->refreshOAuthToken($this);
        $this->refresh();
