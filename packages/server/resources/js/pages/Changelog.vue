...
const entries = computed<Entry[]>(() => [
  {
    ...
    description: t('docChangelog.v171Desc'),
    changes: [
      { type: 'feat', text: t('docChangelog.v171Change1') },
      { type: 'feat', text: t('docChangelog.v171Change2') },
      { type: 'feat', text: t('docChangelog.v171Change3') },
      { type: 'fix', text: t('docChangelog.v171Change4') },
    ],
  },
  {
    version: 'v1.7.0',
    date: t('docChangelog.v170Date'),
    title: t('docChangelog.v170Title'),
    description: t('docChangelog.v170Desc'),
    changes: [
      { type: 'feat', text: t('docChangelog.v170Change1') },
      { type: 'feat', text: t('docChangelog.v170Change2') },
      { type: 'feat', text: t('docChangelog.v170Change3') },
      { type: 'feat', text: t('docChangelog.v170Change4') },
      { type: 'feat', text: t('docChangelog.v170Change5') },
    ],
  },
  {
    version: 'v1.6.0',
    date: t('docChangelog.v160Date'),
    title: t('docChangelog.v160Title'),
    description: t('docChangelog.v160Desc'),
    changes: [
      { type: 'feat', text: t('docChangelog.v160Change1') },
      { type: 'feat', text: t('docChangelog.v160Change2') },
      { type: 'feat', text: t('docChangelog.v160Change3') },
      { type: 'feat', text: t('docChangelog.v160Change4') },
      { type: 'feat', text: t('docChangelog.v160Change5') },
      { type: 'fix', text: t('docChangelog.v160Change6') },
      { type: 'fix', text: t('docChangelog.v160Change7') },
    ],
  },
  {
    version: 'Mobile v0.7.0',
    date: t('docChangelog.v070mDate'),
    title: t('docChangelog.v070mTitle'),
    description: t('docChangelog.v070mDesc'),
    changes: [
      { type: 'feat', text: t('docChangelog.v070mChange1') },
      { type: 'feat', text: t('docChangelog.v070mChange2') },
      { type: 'feat', text: t('docChangelog.v070mChange3') },
      { type: 'feat', text: t('docChangelog.v070mChange4') },
      { type: 'feat', text: t('docChangelog.v070mChange5') },
    ],
  },
  {
    version: 'v1.5.0',
    date: t('docChangelog.v150Date'),
    title: t('docChangelog.v150Title'),
    description: t('docChangelog.v150Desc'),
    changes: [
      { type: 'feat', text: t('docChangelog.v150Change1') },
      { type: 'feat', text: t('docChangelog.v150Change2') },
      { type: 'feat', text: t('docChangelog.v150Change3') },
      { type: 'feat', text: t('docChangelog.v150Change4') },
      { type: 'feat', text: t('docChangelog.v150Change5') },
      { type: 'perf', text: t('docChangelog.v150Change6') },
      { type: 'fix', text: t('docChangelog.v150Change7') },
    ],
  },
  {
