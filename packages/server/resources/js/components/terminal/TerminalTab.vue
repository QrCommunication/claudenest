  ...
  <div class="terminal-tab" :class="{ active: isActive }">
    ...
    <div class="tab-header">
      ...
      <div class="tab-actions">
        <button class="tab-action-btn" :title="t('terminalTerminaltab.search')" @click="toggleSearch">
          <svg viewBox="0 0 20 20" fill="currentColor" class="icon">
            <path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd" />
          </svg>
        </button>
        <button class="tab-action-btn" :title="t('terminalTerminaltab.fitTerminal')" @click="handleFit">
          <svg viewBox="0 0 20 20" fill="currentColor" class="icon">
        ...
        <button
          ...
          :title="t('terminalTerminaltab.terminateSession')"
