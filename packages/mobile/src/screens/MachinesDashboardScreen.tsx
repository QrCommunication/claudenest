...
import { View, Text, FlatList, TouchableOpacity, ActivityIndicator, RefreshControl, ListRenderItemInfo } from 'react-native';
    ...
    <View className="bg-bg2 rounded-2xl p-4 mb-3 border border-bg4">
      ...
      {machine.last_seen_at ? (
        <Text className="text-muted text-xs mb-3">
          Vu {new Date(machine.last_seen_at).toLocaleString()}
        </Text>
      ) : null}
